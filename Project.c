...
char department[][15]={"Computer","Electronics","Electrical","Civil","Mechnnical","Architecture"};
void returnfunc(void);
void mainmenu(void);
void addbooks(void);//bow
void deletebooks(void);//pj
void editbooks(void);//pj
void searchbooks(void);//Bhowmick
void issuebooks(void);//anantha
void viewbooks(void);//anantha
...
int s;
char findbook;
char username1[100]={"Prithwijit"};
char username2[100]={"Anantha"};
char username3[100]={"Rishith"};
char username4[100]={"Bhuvanesh"};
char password[10]={"cool"};
...
void mainmenu()
{
	...
	case '4':
	    ...
	    {
    system("cls");
    MessageBox(0,"Thanks for using Libaray management system","Gratitude",0);
		system("cls");
		gotoxy(16,2);
		printf("Project by:");
		gotoxy(16,4);
		printf("1. Prithwijit Banerjee    PES1201800030");
		gotoxy(16,5);
		printf("");
		gotoxy(16,7);
		printf("2. A Anantha Krishna      PES1201800506");
		gotoxy(16,8);
		printf("");
		gotoxy(16,10);
		printf("3. Rishith Bhowmick       PES1201801912");
		gotoxy(16,11);
		printf("");
		gotoxy(16,13);
    printf("4. B.Bhuvanesh            PES1201801759");
...
void addbooks(void)    //funtion that add books
{
	...
	gotoxy(20,19);
	printf("\xDB\xDB\xDB\xDB\xB2 7. Fiction");
	gotoxy(20,21);
  printf("\xDB\xDB\xDB\xDB\xB2 8. return to the main menu");
  gotoxy(20,23);
	printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
	gotoxy(20,24);
	printf("Enter your choice:");
...
void Password(void) //for password option
{
   ...
   while(ch!=13)
    ...
    pass[i] = '\0';
    if(strcmp(user,username1)==0||strcmp(user,username2)==0||strcmp(user,username3)==0||strcmp(user,username4)==0)
    {
